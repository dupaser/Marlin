...
namespace ExtUI {
  ...
  enum result_t   : uint8_t { PID_STARTED, PID_BAD_EXTRUDER_NUM, PID_TEMP_TOO_HIGH, PID_TUNING_TIMEOUT, PID_DONE, PID_TUNING_ABORT, PID_TUNING_CYCLE }; //Свое добавил штуку PID_TUNING_ABORT + PID_TUNING_CYCLE
  ...
  void onSettingsLoaded(bool success);
    ...
    void onPidTuning(const result_t rst, int heater_type = 50, int cycles = 0, int ncycles = 0 ); //Свое - добавил int / 50 если не передали номер нагревателя
  #endif
};
