...
#define STRING_CONFIG_H_AUTHOR "FROZA3D" // Who made the changes.
...
#elif PRINTER_MODEL == 4 || PRINTER_MODEL == 31
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 48.73
  #define DEFAULT_bedKi 9.09
  #define DEFAULT_bedKd 174.11
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_FUNCTIONAL_RANGE 15 //10 If the temperature difference between the target temperature and the actual temperature
...
#if PRINTER_MODEL == 1 || PRINTER_MODEL == 2 || PRINTER_MODEL == 102 ||  PRINTER_MODEL == 3 || PRINTER_MODEL == 4 || PRINTER_MODEL == 31
    #define COREXY
#endif
...
//#define ENDSTOPPULLDOWNS
  ...
  #if  PRINTER_MODEL == 2 || PRINTER_MODEL == 3 || PRINTER_MODEL == 4 || PRINTER_MODEL == 31
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 100, 830 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 210, 210, 12, 45 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 250, 250, 14, 50 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 50, 1200 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 4000, 4000, 80, 1600 } // ...or, set your own edit limits
#endif
...
#define DEFAULT_EJERK    10.0  //15 May be used by Linear Advance
 ...
 */
#if PRINTER_MODEL == 3 || PRINTER_MODEL == 4 || PRINTER_MODEL == 31
  #define BLTOUCH
#endif
...
#if PRINTER_MODEL == 31
  #define NOZZLE_TO_PROBE_OFFSET { 34, 0, -2 }
#elif PRINTER_MODEL == 3 || PRINTER_MODEL == 4
  #define NOZZLE_TO_PROBE_OFFSET { -38, 15, -1 }
#endif
...
#define Z_PROBE_LOW_POINT          -2 // -2  Farthest distance below the trigger-point to go before stopping
...
//#define Y_BED_SIZE 200
  ...
  #define X_MAX_POS X_BED_SIZE
  #define Y_MAX_POS Y_BED_SIZE
  #define MANUAL_Y_HOME_POS Y_BED_SIZE - 5
  #elif PRINTER_MODEL == 3 
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define NUM_RUNOUT_SENSORS   1          // 1 Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.
  ...
  #define FILAMENT_RUNOUT_SCRIPT "M25" //G92 E0 \nG1 E-1 F2600 \n
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEVELED_SEGMENT_LENGTH 1.0 // 5 (mm) Length of all segments (except the last one)
...
#if PRINTER_MODEL == 1 || PRINTER_MODEL == 2
//#define MANUAL_X_HOME_POS -2
//#define MANUAL_Y_HOME_POS -10
//#define MANUAL_Z_HOME_POS 0
#elif PRINTER_MODEL == 3
...
#define PREHEAT_5_LABEL       "MAX" //добавил сам скопировав строчки
...
//#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { ( 100), (0), 20 }
...
#define DGUS_LCD_UI_MKS //наш дисплей 
